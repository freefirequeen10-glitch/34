...
window.showWinnerSplitPopup = function(event, tournamentId) {
  ...
  // Clean up any pre-existing listener references before opening a new instance
  if (window._popupCleanup) {
    window._popupCleanup();
  }
  ...
  requestAnimationFrame(() => {
    ...
    // Toggle interactive visibility and translation animations
